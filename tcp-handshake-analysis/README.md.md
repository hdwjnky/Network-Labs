...
- **HTTP POST:** The segment carrying the HTTP POST request had a relative sequence number of 164041, letting me confirm exactly where in the byte stream the application data began.
